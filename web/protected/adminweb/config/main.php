...
$adminweb=dirname(dirname(__FILE__));
$frontend=dirname($adminweb);
Yii::setPathOfAlias('adminweb', $adminweb);
...
return array(
	...
	'import'=>array(
		...
		'application.extensions.auto_keywords',
	),
	'defaultController'=>'login', //设置默认控制器类
	'modules'=>array(
